...
public class EventService {
    ...
    public List<Event> getAllUpcomingEvents() {return eventRepository.findByStatus("upcoming");}

    public Event getEventById(Long id) {
        return eventRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Event with id " + id + " not found"));}
