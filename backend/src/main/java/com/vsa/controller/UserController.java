...
public class UserController {
     ...
     *
     * <p>
     * A verification email will be sent to the user's email address. The user
     * must verify their email before they can log in to the system.
     *
     * <p>
     * Endpoint: POST /api/users/register
     *
     * @param user The user details including email, password, first name, and
     * last name
     * @return ResponseEntity with status 201 (Created) and the registered user
     * details
     */
     ...
     *
     * <p>
     * The token is typically sent to the user via email during registration.
     * After successful verification, the user can log in to the system.
     *
     * <p>
     * Endpoint: GET /api/users/verify?token=abc123
     *
     ...
     *
     * <p>
     * On successful authentication, returns a JWT token that can be used for
     * subsequent authenticated requests. The user must have verified their
     ...
     *
     * <p>
     * The reset token is sent to the user via email when they use the
     * forgot-password endpoint. The token must be valid (not expired) for this
