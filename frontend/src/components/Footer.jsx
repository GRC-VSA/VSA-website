        ...
        <div className="home-footer__content">
          ...
          <div className="home-footer__col home-footer__col--center">
            ...
            <div className="home-footer__socials">
              <a href="https://www.instagram.com/vsagrc?igsi=dDFsMThmN3BlNDlk" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="Instagram">
              ...
              <a href="mailto:vsa.greenriver@gmail.com" className="social-btn" aria-label="Email">
              ...
              <a href="https://github.com/GRC-VSA" target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="GitHub">
